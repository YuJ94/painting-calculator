        ...
        while (true) {
            ...
            if (userChoice.equals("1")) {
                ...
                if (shapeChoice.equals("1")) {
                    ...
                    System.out.println("What is the wall side length?");
                    ...
                    System.out.println("What is the wall base?");
                ...
                System.out.println();
                System.out.println("Added " + newWall + " wall - " + newWall.getArea() + " square feet");
                System.out.println();
                walls.add(newWall);
                ...
                for (int i = 0; i < walls.size(); i++) {
                    System.out.println(String.format("Wall %d: %s - %d square ft", i + 1, walls.get(i), walls.get(i).getArea()));
                    totalArea = totalArea + walls.get(i).getArea();
                    colorChoiceAreas.put(walls.get(i).getColor(), colorChoiceAreas.getOrDefault(walls.get(i).getColor(), 0) + walls.get(i).getArea());
                }
